...
<a href="nareshdocs.php"><Div class="lnks"><Font size="5px" color="#ffff00">Home</Font></Div></a></p> </Div> 
 <br><br><br><br>
<Font size="5px" ><h3>Change Password</h3><br>
<form action="" method="POST">  
<div class="inp">
  &nbsp; &nbsp; &nbsp; New Password  &nbsp; &nbsp;: &nbsp; <input type="password" name="pass1"><br /> <br>
Confirm new Password: <input type="password" name="pass2"><br />   <br>
</div>
</Font>
  <p id="msg"><Font Color="red"><?php echo $response ?> </Font></p>
<div class="submit_btn"> <Input  type="submit"  value="Change Password" name="submit" />  </div>
</form>  
  </center>
